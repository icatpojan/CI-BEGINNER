...
class Artisan extends CI_Controller {
	...
	public function model($name = Null, $table = Null, $primaryKey = Null, $extendsName = 'CI_Model')
	{
		...
		if ( ! isset( $name ) ) {
			...
			echo " artisan model some.other.User users user_id MY_Model\n";
